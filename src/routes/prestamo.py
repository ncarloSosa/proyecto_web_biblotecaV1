...
def _build_data(form) -> Dict[str, object]:
    ...
    id_libro = _parse_int(_form_value(form, "LIBRO_ID", "LIBRO_ID_LIBRO", "ID_LIBRO", "libro_id"))
    id_usuario = _parse_int(_form_value(form, "USUARIO_ID", "USUARIO_ID_USUARIO", "ID_USUARIO", "usuario_id"))
