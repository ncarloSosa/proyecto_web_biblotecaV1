...
def _build_data(form) -> Dict[str, object]:
    id_editorial = _parse_int(form.get("ID_VAREDIT"), "una editorial")
    id_libro = _parse_int(form.get("LIBRO_ID_LIBRO"), "un libro")
    fecha_edicion = _parse_date(form.get("FECHA_EDICION"))
    return {
        "ID_VAREDIT": id_editorial,
