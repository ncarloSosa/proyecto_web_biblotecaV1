...
def crear(data: Dict[str, object]) -> None:
    """Insert a loan row without duplicating columns or stray binds."""
    ...
    if fp:
        ...
        if get_col_datatype(table, fp) == "DATE":
            if fecha_prestamo:
                columns[fp] = "TO_DATE(:fpr,'YYYY-MM-DD')"
